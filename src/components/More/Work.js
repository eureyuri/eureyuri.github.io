...
export default function Work({ micronImage, niImage, teamLabImage, influImage }) {
    return (
        <div>
            <TabGridLayout
                logo={<Img fluid={micronImage} />}
